...
ControllerAll = false
local ListSudos ={Sudo_Id,1830833337}  
...
if UserId == 1830833337 then
Status = true
elseif UserId == 1830833337 then
Status = true
...
return {
Lock     = '[. ‹ Snap 𝖳𝖾𝖺𝗆 . ](https://t.me/cSccSccc)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه المسح *',
unLock   = '[. ‹ Snap 𝖳𝖾𝖺𝗆 . ](https://t.me/cSccSccc)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[. ‹ Snap 𝖳𝖾𝖺𝗆 . ](https://t.me/cSccSccc)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه الكتم *',
lockKid  = '[. ‹ Snap 𝖳𝖾𝖺𝗆 . ](https://t.me/cSccSccc)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه التقييد *',
lockKick = '[. ‹ Snap 𝖳𝖾𝖺𝗆 . ](https://t.me/cSccSccc)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه الطرد *',
Reply    = '[. ‹ Snap 𝖳𝖾𝖺𝗆 . ](https://t.me/cSccSccc)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n🔰 : المستخدم⇷ *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
if tonumber(msg.sender.user_id) == 1830833337 then
msg.Name_Controller = 'مطوࢪ السوࢪس  '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1830833337 then
...
local N = (Redis:get(ThesookB.."Name:Bot") or "سناب")
...
{
{text = '. ‹ Snap 𝖳𝖾𝖺𝗆 . ', url='https://t.me/cSccSccc'},
},
}
}
...
NamesBot = (Redis:get(ThesookB.."sookB:Name:Bot") or "سناب")
...
{
{text = Jabwa, url = 'https://t.me/PRO00D'}, 
},
{
{text = Grosupsw, url = 'https://t.me/cSccSccc'}, 
},
{
{text = Usperos, url = 'https://t.me/cSccSccc'}, 
},
}
...
{
{text = ' ❲ ‹ 𝖲𝗈𝗎𝗋𝖼𝖾 Snap . ❳ ',url="https://t.me/cSccSccc"}
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,'\n*‹ : اهلا بك مجددا عزيزي \n‹ : اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس  Snapفقط اضغط على الامر الذي تريد تنفيذه *','md', true, false, false, false, reply_markup)
end
...
{{text =news,url = "https://t.me/cSccSccc"}, },}}
...
if text == "غنيلي" then
Abs = math.random(2,140); 
local Text =" [‹ : تم اختياࢪ الاغنيه لك : -](t.me/cSccSccc)"
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text == "شعر" then
Abs = math.random(2,140); 
local Text =" [‹ : تم اختياࢪ الشعر لك :  ](t.me/cSccSccc)"
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '. ‹ Snap 𝖳𝖾𝖺𝗆 . ',url="t.me/cSccSccc"}
},
{
...
if text == "ميمز" then
Abs = math.random(2,140); 
local Text =" [متحركات Gٍٓif ᯓ ](t.me/cSccSccc)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '. ‹ Snap 𝖳𝖾𝖺𝗆 . ',url="t.me/cSccSccc"}},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/https://t.me/cSccSccc/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local UserId_Info = LuaTele.searchPublicChat("PRO00D")
...
if photo.total_count > 0 then
local TestText = "  . ‹ Snap 𝖳𝖾𝖺𝗆 . \n⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n ‹ : *Dev Name* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n‹ : *Dev Bio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖼𝗈𝖽𝖾𝗋 ❳', url = "https://t.me/PRO00D"}
},
{
{text = '. ‹ Snap 𝖳𝖾𝖺𝗆 . ', url='https://t.me/cSccSccc'},
},
...
local UserId_Info = LuaTele.searchPublicChat("@cSccSccc")
if UserId_Info.id then
local UserInfo = LuaTele.getUser(UserId_Info.id)
local InfoUser = LuaTele.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𝗎𝗉𝖽𝖺𝗍𝖾’s ❳', url = "https://t.me/cSccSccc"}
},
{
{text = '- Snap  𝖲𝗈𝗎𝗋𝖼𝖾 .', url='https://t.me/cSccSccc'},
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete snapchat',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.sookBchat.com%2Faccounts%2Fdeleteaccount"}},{{text= ' سورس  Snap',url="t.me/cSccSccc"}}
}
local msg_id = msg.id/2097152/0.5
...
keyboard.inline_keyboard = {
{
{text = '𝗎𝗉𝖽𝖺𝗍𝖾𝗌', url = 'https://t.me/cSccSccc'},{text = '. ‹ Snap 𝖳𝖾𝖺𝗆', url = 'https://t.me/cSccSccc'}, 
},
{
{text = 'مبࢪمج اݪسوࢪس', url = 't.me/PRO00D'}, 
},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/cSccSccc&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "منو اني" then
if msg.sender.user_id == tonumber(1830833337) then
LuaTele.sendText(msg_chat_id,msg_id,"‹ : انت الربيعي مطور السورس يقلبي🌚💘","md",true)
...
if text == (Redis:get(ThesookB.."sookB:Name:Bot") or "سناب") then
local NamesBot = (Redis:get(ThesookB.."sookB:Name:Bot") or "سناب")
local NameBots = {
"يروح "..NamesBot.. " كول؟",
"انا "..NamesBot.. " القميل",
"هاعمري",
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 'https://t.me/cSccSccc'}, 
},
{
...
"اختفوووو يلعار ابلع من عمك الربيعي??🏃‍♀️.",
...
{
{text = '‹ : شࢪوحات السوࢪس -', url = 't.me/cSccSccc'},
},
{
{text = '‹ : سۅࢪس  Snap-', url = 't.me/cSccSccc'},
},
}
}
...
{
{text = '‹ : شࢪوحات السوࢪس', url = 't.me/cSccSccc'}, {text = '‹ : شراء بوت', url = 't.me/PRO00D'},
},
{
{text = '‹ : . ‹ Snap 𝖳𝖾𝖺𝗆 .', url = 't.me/cSccSccc'},
},
...
reply_markup = {
inline_keyboard ={
{{text ="ch", url= "https://t.me/cSccSccc"}},
}
},
},
}
...
if tonumber(IdUser) == tonumber(UserId) then
Abs = math.random(2,54); 
local Text ='* . ‹ Snap 𝖳𝖾𝖺𝗆 . \n⋆┄┄─┄─┄─┄┄─┄─┄┄⋆*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '❲ ‹ 𝖲𝗈𝗎𝗋𝖼𝖾 Snap . ❳',url="https://t.me/cSccSccc"},{text = ' Updates source ⁦ᯓ',url="https://t.me/cSccSccc"}
},
{
{text = ' مبࢪمج السورس',url="https://t.me/PRO00D"}
},
}
local msg_id = Msg_id/2097152/0.5
...
{
{text = '❲ ‹ Snap 𝖲𝗈𝗎𝗋𝖼𝖾 ❳',url="t.me/cSccSccc"}
},
}
local msg_id = Msg_id/2097152/0.5
...
{
{text = '𝖲𝗈𝗎𝗋𝖼𝖾 ‹ Snap:',url="t.me/cSccSccc"}
},
}
local msg_id = Msg_id/2097152/0.5
...
local TextHelp = [[*
‹ : أهلا بك في قائمة العاب سورس  Snapاختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
‹ : مرحبا بك في الالعاب المتطورة الخاص بسورس  Snap
